...
describe("list all items", () => {
  ...
  it("should read data from database", async () => {
    ...
    expect(response.body.data[0].hasProductionNumber).toEqual(
      data.hasProductionNumber
    );
    ...
    expect(response.body.data[1].hasProductionNumber).toEqual(
      data2.hasProductionNumber
    );
...
describe("read item", () => {
  ...
  it("should read data from database", async () => {
    ...
    expect(response.body.data.hasProductionNumber).toEqual(
      data.hasProductionNumber
    );
